...
export const BankingDashboard = () => {
  ...
  return (
    <div className="min-h-screen flex w-full">
      {/* Hamburger Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 w-64 bg-card/95 backdrop-blur-glass border-r border-border shadow-glass transform ${
      ...
      >
        <div className="p-4">
          ...
          <nav className="space-y-2">
            ...
            <Button variant="ghost" className="w-full justify-start" onClick={() => navigate('/transfer')}>
            ...
            <Button variant="ghost" className="w-full justify-start" onClick={() => navigate('/savings')}>
