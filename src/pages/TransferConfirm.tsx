...
//       } catch (error) {
//         console.error('Error checking transfer settings:', error);
//         // On error, default to success mode for better user experience
//         forceSuccess = true;
//       }
//     }
...
//       console.log('Failure mode activated: Going through full verification flow');
//       navigate("/transfer/tac", { state: transferData });
//     } else {
//       // SUCCESS MODE: Direct route to OTP (skip all verification steps)
//       console.log('Success mode activated: Direct to OTP');
//       navigate("/transfer/otp", { state: transferData });
//     }
//   };
    ...
    if (user) {
      try {
        ...
        if (!error && data !== null) {
          ...
          console.log('🔍 DEBUG - No setting found or error occurred, using default:', forceSuccess);
        }
      } catch (error) {
